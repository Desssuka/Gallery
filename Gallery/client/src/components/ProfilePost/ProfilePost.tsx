        ...
        <div>
            ...
            className={s.modal} cancelText="Delete post" footer={[
                ...
                <div className={s.info}>
                    ...
                    {!isDescEdit 
                    ? <p className={s.description} onDoubleClick={() =>{
                        if(props.userId === auth.id) setIsDescEdit(true)
                    } }>{description}</p> 
                    : <Input value={description} onChange={e => setDescription(e.target.value)} onBlur={() => {
                        posts.updateDescription(description, props.id)
                        setIsDescEdit(false)
                    }}/>
                    }
                </div>
